...
public class TablaHash {
    ...
    /**
     * Crea una lista con las habitaciones que están siendo ocupadas en el momento
     * @return Lista de habtiaciones ocupadas
     */
    public Lista habitacionesOcupadas(){
        Lista<String> nuevaLista = new Lista();
        
        for(Lista<Estado> lista: tabla){
            
            for (int i = 0; i < nuevaLista.getNumElementos(); i++) {
                Estado estado = lista.obtener(i);
                nuevaLista.agregarFinal(estado.getNumHabitacion());
            }
        }
