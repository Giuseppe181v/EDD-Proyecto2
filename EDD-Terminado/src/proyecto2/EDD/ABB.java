...
public class ABB<T> {
    ...
    */
    ...
    public void obtenerHistorialHab(NodoABB<Historico> nodoActual, String numHab, Lista lista){
        if(nodoActual != null){
            if(nodoActual.getDato().getNumHabitacion().equals(numHab)){
                lista.agregarFinal(nodoActual.getDato());
            }
            obtenerHistorialHab(nodoActual.getIzquierdo(), numHab, lista);
            obtenerHistorialHab(nodoActual.getDerecho(), numHab, lista);
