...
public class ABB<T> {
    ...
    */
    ...
    public Historico buscarHistorico(String numHabitacion) {
    ...
    if (raiz == null) {
        ...
        // Compara el número de habitación del nodo actual con el número de habitación buscado
        int comparacion = numHabitacion.compareTo(datoNodoActual.getNumHabitacion());
        
        // Si el número de habitación buscado es menor, busca en el subárbol izquierdo
        if (comparacion < 0) {
            return buscarHistorico(raiz.getIzquierdo(), numHabitacion);
        }
        // Si el número de habitación buscado es mayor, busca en el subárbol derecho
        else if (comparacion > 0) {
            return buscarHistorico(raiz.getDerecho(), numHabitacion);
        }
        // Si el número de habitación es igual, se encontró el historial
        else {
            return datoNodoActual;
        }
    }
...
private Historico buscarHistorico(NodoABB nodo, String numHabitacion) {
   
    if (nodo == null) {
        return null;
    } else {
       
        Historico datoNodoActual = (Historico) nodo.getDato();
        ...
        // Si el número de habitación buscado es menor, busca en el subárbol izquierdo
        if (comparacion < 0) {
            return buscarHistorico(nodo.getIzquierdo(), numHabitacion);
        }
        // Si el número de habitación buscado es mayor, busca en el subárbol derecho
        else if (comparacion > 0) {
            return buscarHistorico(nodo.getDerecho(), numHabitacion);
        }
        // Si el número de habitación es igual, se encontró el historial
        else {
            return datoNodoActual;
